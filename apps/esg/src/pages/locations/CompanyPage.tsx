...
export const CompanyPage: React.FC = () => {
	...
	const handleDelete = () => {
		...
		showDialog({
			title: '사업자 삭제 확인',
			content:
				'선택한 사업자를 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
			confirmText: '삭제',
			cancelText: '취소',
			severity: 'error',
			onConfirm: () => {
			...
			>
				<DynamicFormComponent
					...
					otherTypeElements={{
						...
						businessItem: BusinessItemSelect,
					}}
				/>
			</BaseModalComponent>
			<SplitPanelComponent
						...
						onDelete={(row) => {
							...
							if (!selectedCompanyId) {
								...
								showDialog({
									title: '사업자 삭제 확인',
									content:
										'선택한 사업자을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
									confirmText: '삭제',
									cancelText: '취소',
									severity: 'error',
									onConfirm: () => {
