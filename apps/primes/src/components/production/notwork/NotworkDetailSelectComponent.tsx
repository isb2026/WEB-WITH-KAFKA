...
import { useNotworkDetailFieldQuery } from '@primes/hooks/production';

interface NotworkDetailSelectComponentProps {
...
export const NotworkDetailSelectComponent: React.FC<
	NotworkDetailSelectComponentProps
> = ({
	...
	onChange,
	disabled = false,
	placeholder = '비가동 Detail을 선택하세요',
}) => {
	const { data, isLoading, error } = useNotworkDetailFieldQuery(fieldKey);
