...
const QualityFinalInspectionReportPage: React.FC = () => {
	...
	const inspectionInfo = useMemo((): InspectionInfo | null => {
		...
		return {
			...
			inspectionType: checkingHead.inspectionType || t('inspection.type.final'),
						...
						<div className="space-y-2 text-sm">
							<div className="flex justify-between">
								<span className="text-gray-600">
									{t('inspection.report.workOrderLot')}:
								</span>
								<span className="font-medium">
...
export default QualityFinalInspectionReportPage;
