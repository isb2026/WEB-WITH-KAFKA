...
// MAIN COMPONENT
// ============================================================================
const QualityOutgoingInspectionReportPage: React.FC = () => {
	// ============================================================================
	// HOOKS
	// ============================================================================
	...
	const inspectionInfo = useMemo((): InspectionInfo | null => {
		...
		return {
			...
			inspectionType: checkingHead.inspectionType || t('inspection.type.outgoing'),
...
export default QualityOutgoingInspectionReportPage;
