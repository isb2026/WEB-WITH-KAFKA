...
const QualityEquipmentInspectionReportPage: React.FC = () => {
	...
	// checkingHeads 데이터에서 실제 검사 정보 추출
	const inspectionInfo = useMemo((): InspectionInfo | null => {
		...
		return {
			...
			inspectionType: checkingHead.inspectionType || t('inspection.type.machine'),
			machineCode: meta.machineCode || 'N/A',
			machineName: meta.machineName || 'N/A',
			machineTypeCode: meta.machineTypeCode || 'N/A',
			inspectorName: meta.inspectorName || 'N/A',
			status: checkingHead.isUse ? t('inspection.report.completed') : t('inspection.report.waiting'),
	...
	const handleBack = () => {
		navigate('/quality/equipment-inspection/list');
	};
	...
	if (!inspectionInfo || !checkingHead) {
		return (
			<div className="max-w-full p-4 h-full flex flex-col">
				<h1 className="text-xl font-bold mt-2 mb-3">{t('inspection.report.equipmentTitle')}</h1>
		...
		<div className="max-w-full p-4 h-full flex flex-col">
			...
			<div className="bg-white rounded-lg border p-6 mb-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					...
					<div className="space-y-3">
						<h3 className="font-medium text-gray-700 border-b pb-2">
							{t('inspection.report.machineInfoTitle')}
						</h3>
						<div className="space-y-2 text-sm">
							<div className="flex justify-between">
								<span className="text-gray-600">
									{t('inspection.machineCode')}:
								</span>
								<span className="font-medium">
									{inspectionInfo.machineCode}
								</span>
							</div>
							<div className="flex justify-between">
								<span className="text-gray-600">{t('inspection.machineName')}:</span>
								<span className="font-medium">
									{inspectionInfo.machineName}
								</span>
							</div>
							<div className="flex justify-between">
								<span className="text-gray-600">{t('inspection.form.machineTypeLabel')}:</span>
								<span>{inspectionInfo.machineTypeCode}</span>
							</div>
							<div className="flex justify-between">
					...
					<div className="space-y-3">
						...
						<div className="space-y-2 text-sm">
							<div className="flex justify-between">
								<span className="text-gray-600">
									{t('inspection.report.totalInspectionItems')}:
								</span>
								<span className="font-medium">
...
export default QualityEquipmentInspectionReportPage;
