...
// 메인 컴포넌트
// ============================================================================
const QualityEquipmentInspectionEditPage: React.FC = (): JSX.Element => {
	// ========================================================================
	// 기본 훅 및 번역
	// ========================================================================
	...
	useEffect(() => {
		...
		setMasterData({
			machineId: meta.machineId || 0,
			machineCode: meta.machineCode || headData.targetCode || '',
			machineName: meta.machineName || '',
			machineTypeCode: meta.machineTypeCode || '',
	...
	// ========================================================================
	useEffect(() => {
		if (formMethodsRef.current && masterData.machineName) {
		...
		<div className="max-w-full mx-auto p-4 h-full flex flex-col">
			...
			>
				...
				<div className="border rounded-lg h-full overflow-auto">
					...
					<div className="p-4">
						<DynamicForm
							key="quality-equipment-inspection-edit-form"
...
export default QualityEquipmentInspectionEditPage; 