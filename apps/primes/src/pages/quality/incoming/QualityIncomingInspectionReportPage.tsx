...
// MAIN COMPONENT
// ============================================================================
const QualityIncomingInspectionReportPage: React.FC = () => {
	// ============================================================================
	// HOOKS
	// ============================================================================
	...
	const inspectionInfo = useMemo((): InspectionInfo | null => {
		...
		return {
			...
			inspectionType: checkingHead.inspectionType || t('inspection.type.incoming'),
...
export default QualityIncomingInspectionReportPage;
