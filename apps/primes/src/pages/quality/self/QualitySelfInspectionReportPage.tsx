...
// MAIN COMPONENT
// ============================================================================
const QualitySelfInspectionReportPage: React.FC = () => {
	// ============================================================================
	// HOOKS
	// ============================================================================
	...
	const inspectionInfo = useMemo((): InspectionInfo | null => {
		...
		return {
			...
			inspectionType: checkingHead.inspectionType || t('inspection.type.self'),
...
export default QualitySelfInspectionReportPage;
