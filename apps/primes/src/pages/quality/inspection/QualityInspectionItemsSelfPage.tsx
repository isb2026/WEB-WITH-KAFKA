...
const QualityInspectionItemsSelfPage: React.FC = () => {
		...
		try {
			if (editingInspection) {
				...
				const updateData = {
					...
					targetCode: currentProgress?.code || editingInspection.targetCode,
				...
				const apiData = {
					...
					targetCode: currentProgress?.code || '',
...
export default QualityInspectionItemsSelfPage;
