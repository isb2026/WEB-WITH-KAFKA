...
import { useInspectionPrecisionFormSchema } from '@primes/schemas/inspection';
import { UseFormReturn } from 'react-hook-form';
import { useRef } from 'react';

const QualityInspectionItemsPrecisionPage: React.FC = () => {
	...
	const inspectionPrecisionFormSchema = useInspectionPrecisionFormSchema();
			...
			<DraggableDialog
				...
				content={
					<DynamicForm
						...
						fields={inspectionPrecisionFormSchema.map((field) => ({
							...field,
...
export default QualityInspectionItemsPrecisionPage;
