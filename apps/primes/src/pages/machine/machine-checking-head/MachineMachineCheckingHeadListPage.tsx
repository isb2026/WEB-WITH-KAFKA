...
// import { useMachineCheckingHead } from '@primes/hooks';
import { useDataTable } from '@radix-ui/hook';
import { SearchSlotComponent } from '@primes/components/common/search/SearchSlotComponent';

interface MachineMachineCheckingHeadListData {
	id: number;
	name?: string;
	code?: string;
	status?: string;
...
export const MachineMachineCheckingHeadListPage: React.FC = () => {
	const [page, setPage] = useState<number>(0);
	const [data, setData] = useState<MachineMachineCheckingHeadListData[]>([]);
	...
	const tableColumns = [
		...
		{
			accessorKey: 'machineCheckingDatas',
			header: 'machineCheckingDatas',
			size: 150,
		},
	];
	...
	return (
		<PageTemplate firstChildWidth="30%" className="border rounded-lg">
			<DatatableComponent
				...
				data={data}
				tableTitle="machine-checking-head 관리 목록"
...
export default MachineMachineCheckingHeadListPage;
