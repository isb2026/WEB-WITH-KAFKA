...
interface TaxInvoiceDetailRegisterActionsProps {
	newTaxInvoiceMasterId: number | null;
	...
	onAddClick: () => void;
	onEditClick: (detail: TaxInvoiceDetail) => void;
	onDeleteClick: (detail: TaxInvoiceDetail) => void;
	onAddRowClick?: () => void;
	onSaveAddRows?: () => void;
	hasAddRowData?: boolean;
}

export const TaxInvoiceDetailRegisterActions = ({
	...
	onSaveAddRows,
	hasAddRowData = false,
}: TaxInvoiceDetailRegisterActionsProps) => {
	...
	return (
		<div className="flex items-center gap-2.5 ">
			...
			<RadixButton
				...
				disabled={newTaxInvoiceMasterId === null}
			...
			<RadixButton
				...
				disabled={newTaxInvoiceMasterId === null || !hasAddRowData}
...
export default TaxInvoiceDetailRegisterActions;
