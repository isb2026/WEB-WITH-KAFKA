...
interface EstimateDetailRegisterActionsProps {
	newEstimateMasterId: number | null;
	...
	onAddClick: () => void;
	onEditClick: (detail: EstimateDetail) => void;
	onDeleteClick: (detail: EstimateDetail) => void;
	onAddRowClick?: () => void;
	onSaveAddRows?: () => void;
	hasAddRowData?: boolean;
}

export const EstimateDetailRegisterActions = ({
	newEstimateMasterId,
	selectedRows,
	listByMasterId,
	onAddClick,
	...
	onSaveAddRows,
	hasAddRowData = false,
}: EstimateDetailRegisterActionsProps) => {
	...
	return (
		<div className="flex items-center gap-2.5 ">
			...
			<RadixButton
				...
				disabled={newEstimateMasterId === null}
			...
			<RadixButton
				...
				disabled={newEstimateMasterId === null || !hasAddRowData}
...
export default EstimateDetailRegisterActions;
