...
import { MachineMachinePartOrderInRegisterPage } from '@primes/pages/machine/machine-part-order-in/MachineMachinePartOrderInRegisterPage'
...
const MachinePartOrderInTabNavigation: React.FC<TabNavigationProps> = ({ activetab }) => {
	...
	return (
		<>
			<DraggableDialog
				...
				title={`${t('tabs.titles.machinePartManagement')} ${t('tabs.titles.incoming')} ${t('tabs.actions.register')}`}
				content={
			...
			/>
			<TabLayout
				title={`${t('tabs.titles.machinePartManagement')}`}
				tabs={tabs}
...
export default MachinePartOrderInTabNavigation;
