...
import {
	QualityFinalAnalysisPage,
	QualityFinalInspectionListPage,
...
const FinalInspectionTabNavigation: React.FC<TabNavigationProps> = ({
	activetab,
}) => {
	...
	useEffect(() => {
		...
		if (pathname.includes('/quality/final-inspection/list')) {
			setCurrentTab('list');
		} else if (pathname.includes('/quality/final-inspection/report')) {
	...
	const tabs: TabItem[] = [
		{
			...
			content: <QualityFinalInspectionListPage />,
		},
		{
			id: 'analysis',
			...
			content: <QualityFinalAnalysisPage />,
		},
	];
	...
	const RegisterButton = () => (
		<div className="ml-auto shrink-0 flex-grow-0 flex gap-2">
			<RadixIconButton
				...
				onClick={() => navigate('/quality/final-inspection/register')}
			>
				<Plus size={16} />
	...
	return (
		<TabLayout
			title={t('tabs.titles.finalInspection')}
			tabs={tabs}
...
export default FinalInspectionTabNavigation;
