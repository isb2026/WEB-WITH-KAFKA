...
import AvatarDemoPage from './demo/AvatarDemo';

const AvatarDemoWithCodePage: React.FC = () => {
	const codeString = `
import React from 'react';
import {
	RadixAvatarRoot,
...
const AvatarDemo = () => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
			...
			<div className="bg-white p-6 rounded-lg shadow-md text-center">
				<h3 className="text-lg font-semibold mb-4">Avatar with Fallback</h3>
				<div className="flex justify-center">
					<RadixAvatarRoot className="flex h-16 w-16 select-none items-center justify-center overflow-hidden rounded-full bg-gray-100">
						<RadixAvatarImage
							className="h-full w-full object-cover"
			...
			{/* Square Avatar */}
			<div className="bg-white p-6 rounded-lg shadow-md text-center">
				<h3 className="text-lg font-semibold mb-4">Square Avatar</h3>
				<div className="flex justify-center">
			...
			{/* Avatar with Border */}
			<div className="bg-white p-6 rounded-lg shadow-md text-center">
				<h3 className="text-lg font-semibold mb-4">Avatar with Border</h3>
				<div className="flex justify-center">
			...
			{/* Multiple Avatars */}
			<div className="bg-white p-6 rounded-lg shadow-md text-center">
				<h3 className="text-lg font-semibold mb-4">Multiple Avatars</h3>
		...
		<div className="min-h-screen w-full bg-gray-50 px-4 py-10">
			<div className="max-w-3xl mx-auto">
				...
				<p className="text-sm text-gray-500 mb-6">
					아래는 Radix Avatar 컴포넌트의 사용 예시입니다. Preview 탭에서
					결과를, Code 탭에서 코드를 확인할 수 있습니다.
				</p>

				<PreviewCodeTabs
					preview={<AvatarDemoPage />}
					code={
...
export default AvatarDemoWithCodePage; 