...
import CheckboxDemoPage from './demo/CheckboxDemo';

const CheckboxDemoWithCodePage: React.FC = () => {
	const codeString = `
	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
			...
			<div className="bg-white p-6 rounded-lg shadow-md">
				<h3 className="text-lg font-semibold mb-4">Single Checkbox Example</h3>
				<form>
			...
			<div className="bg-white p-6 rounded-lg shadow-md">
				<h3 className="text-lg font-semibold mb-4">Multiple Choice Example</h3>
		...
		<div className="min-h-screen w-full bg-gray-50 px-4 py-10">
			<div className="max-w-3xl mx-auto">
				...
				<p className="text-sm text-gray-500 mb-6">
					아래는 Radix Checkbox 컴포넌트의 사용 예시입니다. Preview
					탭에서 결과를, Code 탭에서 코드를 확인할 수 있습니다.
				</p>

				<PreviewCodeTabs
					preview={<CheckboxDemoPage />}
					code={
...
export default CheckboxDemoWithCodePage;
