...
import { IniFacilityRegisterPage } from './IniFacilityRegisterPage';
...
export const IniFacilityListPage: React.FC = () => {
		...
		<>
			...
			<PageTemplate firstChildWidth="30%" className="border rounded-lg">
				<DatatableComponent
					...
					data={data}
					tableTitle={tCommon('pages.titles.facilityList')}
...
export default IniFacilityListPage;
