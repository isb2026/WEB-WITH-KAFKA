...
interface IniFacilityRegisterPageProps {
	onClose?: () => void;
	itemsData?: Item;
...
export const IniFacilityRegisterPage: React.FC<
	IniFacilityRegisterPageProps
> = ({ onClose, itemsData, onFormReady }) => {
...
export default IniFacilityRegisterPage;
