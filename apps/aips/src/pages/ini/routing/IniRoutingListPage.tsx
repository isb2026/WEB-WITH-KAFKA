...
import { IniRoutingRegisterPage } from './IniRoutingRegisterPage';
...
export const IniRoutingListPage: React.FC = () => {
		...
		<>
			...
			<PageTemplate firstChildWidth="30%" className="border rounded-lg">
				<DatatableComponent
					...
					data={data}
					tableTitle={tCommon('pages.titles.routingList')}
...
export default IniRoutingListPage;
